...
package com.fitnessapp.progress.view;
...
import com.fitnessapp.progress.utils.OnProgressViewListener;
import com.fitnessapp.progress.utils.ProgressShape;
import com.fitnessapp.progress.utils.ProgressStartPoint;
...
abstract class ProgressView extends View implements ProgressShape {
    ...
    protected int backgroundColor = getResources().getColor(R.color.circle_background_color);
    protected int color = getResources().getColor(R.color.circle_progress_color);
    ...
    private int shaderColor = getResources().getColor(R.color.circle_shader_color);
